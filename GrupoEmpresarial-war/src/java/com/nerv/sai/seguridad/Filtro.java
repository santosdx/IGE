...
public class Filtro implements Filter {
    ...
    private boolean noProteger(String urlStr) {
             ...
             */
              ...
              /*if (urlStr.indexOf("/GrupoEmpresarial-war/login.xhtml") != -1)
                        return true;
              if (urlStr.indexOf("/GrupoEmpresarial-war/plantilla.xhtml") != -1)
                        return true;
              if (urlStr.indexOf("/GrupoEmpresarial-war/menu.xhtml") != -1)
                        return true;
              if (urlStr.indexOf("/GrupoEmpresarial-war/sessionAlertTimeOut.xhtml") != -1)
                        return true;*/
              return false;
    }
}
